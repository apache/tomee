...
public class ConnectorWithApplicationResourcesInWarTest2 {
    ...
    public static WebArchive createDeployment() {
        ...
        final WebArchive webArchive = ShrinkWrap.create(WebArchive.class, "villain-sample-war.war");
        webArchive.addPackage("org.superbiz.application.villain");
