...
public class NamingBean {
    ...
    */
    public static boolean listContext(Context context, String ctxName, PrintWriter writer) throws javax.naming.NamingException {
        writer.println("\n### Context: " + ctxName);
        ...
        final NamingEnumeration<NameClassPair> content = context.list(namespace);
