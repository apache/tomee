...
public class CdiJndiTest {
    @Deployment
    public static Archive<?> app() {
        return ShrinkWrap.create(WebArchive.class, "CdiJndiTest.war")
                .addClasses(TheExtension.class)
                .addAsWebInfResource(EmptyAsset.INSTANCE, "beans.xml")
                .addAsServiceProvider(Extension.class, TheExtension.class);
    }

    @Inject
    private TheExtension extension;
