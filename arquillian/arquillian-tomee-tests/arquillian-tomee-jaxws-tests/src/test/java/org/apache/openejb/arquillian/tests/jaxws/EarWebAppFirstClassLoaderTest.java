...
public class EarWebAppFirstClassLoaderTest {
    ...
    public static Archive<?> ear() {
        final File[] joda = Maven.configureResolver()
                ...
                .resolve("joda-time:joda-time:2.14.2")
    ...
    public void checkIfWasCorretlyLoaded() throws IOException {
        ...
        assertTrue(slurp.endsWith("broken-web/WEB-INF/lib/joda-time-2.14.2.jar"));
        assertFalse(slurp.endsWith("broken/lib/joda-time-2.14.2.jar")); // useless cause of the previous but to make it obvious
    }
}
