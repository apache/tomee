...
public class SimpleApplicationWithLongMappingTest {
    ...
    public static WebArchive war() {
        return ShrinkWrap.create(WebArchive.class, "SimpleApplicationWithLongMappingTest.war")
            ...
            .setWebXML(new StringAsset("<web-app xmlns=\"https://jakarta.ee/xml/ns/jakartaee\" version=\"6.0\">" +
                ...
                "<servlet-mapping>" +
                "<servlet-name>REST Application</servlet-name>" +
                "<url-pattern>/mapping/part2/*</url-pattern>" +
                "</servlet-mapping>" +
                "</web-app>"));
    }
    ...
    public void initBaseUrl() {
        BASE_URL = base.toExternalForm() + "mapping/part2";
    }
