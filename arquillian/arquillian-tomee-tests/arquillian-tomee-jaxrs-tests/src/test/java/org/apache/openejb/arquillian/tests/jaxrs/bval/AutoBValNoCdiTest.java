...
public class AutoBValNoCdiTest {
    ...
    public static WebArchive war() { // no beans.xml: the resource is not a CDI bean
        return ShrinkWrap.create(WebArchive.class, "AutoBValNoCdiTest.war")
            .addClass(AutoBValNoCdiTest.class)
