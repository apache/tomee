...
public class EclipseLinkTest {
    ...
    public static WebArchive war() {
        return ShrinkWrap.create(WebArchive.class, "eclipse-app.war")
    ...
    public void checkEmIsEclipseLinkOne() throws Exception {
        ...
        assertTrue(((ReloadableEntityManagerFactory) emf).getDelegate().getClass().getName().startsWith("org.eclipse."));
    }
}
