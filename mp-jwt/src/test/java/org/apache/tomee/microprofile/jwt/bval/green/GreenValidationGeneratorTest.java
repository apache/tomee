...
import org.apache.tomee.microprofile.jwt.bval.Asmifier;
...
public class GreenValidationGeneratorTest {
    ...
    public void testJwtGenerator() throws Exception {
        ...
        final String actual = Asmifier.asmify(generator.generate());
        final String expected = Asmifier.asmify(Asmifier.readClassFile(Green$$JwtConstraints.class));
    ...
    public void testReturnGenerator() throws Exception {
        ...
        final String actual = Asmifier.asmify(generator.generate());
        final String expected = Asmifier.asmify(Asmifier.readClassFile(Green$$ReturnConstraints.class));
