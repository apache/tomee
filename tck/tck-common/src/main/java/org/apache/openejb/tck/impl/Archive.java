    ...
    public Archive(Iterable<URL> urls, Iterable<Class<?>> classes) {
        ...
        try {
            ...
            for (Class clazz : classes) {
                ...
                // cla  zz.getName().replace('.', File.separatorChar) + ".class"; // shouldn't work under windows
            ...
            for (final URL url : urls) {
                ...
                willBeDeployed = willBeDeployed
                        ...
                        || "ejb-jar.xml".equals(fileName) || "beans.xml".equals(fileName)
                        || "application.xml".equals(fileName) || "application-client.xml".equals(fileName); // TODO: put eveything in a list: org.apache.openejb.config.DeploymentLoader.discoverModuleType()
            }
