...
public class TomcatJndiSupport extends RpcContainerWrapper {
    ...
    public TomcatJndiSupport(RpcContainer container) throws OpenEJBException {
        ...
        org.apache.openejb.DeploymentInfo[] deploymentInfos = container.deployments();
        for (int i = 0; i < deploymentInfos.length; i++) {
            org.apache.openejb.core.CoreDeploymentInfo deployment = (org.apache.openejb.core.CoreDeploymentInfo) deploymentInfos[i];
