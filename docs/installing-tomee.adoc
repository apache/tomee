...
https://tomee.apache.org/download-ng.html[Downloads] page. If you are not sure which one to
...
To run TomEE as a service, see link:deamon/lin-service.html[Linux service] for Linux, and link:deamon/win-service.html[Windows service] for Windows.