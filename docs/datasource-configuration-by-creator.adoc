...
Note: details are at
https://tomee.apache.org/containers-and-resources.html (note:
https://commons.apache.org/proper/commons-dbcp/configuration.html uses
...
Note: details are at https://tomcat.apache.org/tomcat-11.0-doc/jdbc-pool.html
