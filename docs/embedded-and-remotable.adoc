...
Provided you have the openejb-ejbd jar in your classpath along with its
...
link:https://github.com/apache/tomee/tree/main/examples/telephone-stateful[telephone-stateful]
example directory._
...
link:https://github.com/apache/tomee/blob/main/examples/telephone-stateful/src/main/java/org/superbiz/telephone/TelephoneBean.java[TelephoneBean.java]

== business interface

link:https://github.com/apache/tomee/blob/main/examples/telephone-stateful/src/main/java/org/superbiz/telephone/Telephone.java[Telephone.java]

[TIP]
.EJB3 Notes
====
The bean class uses the annotation `@Remote` but
...
link:https://github.com/apache/tomee/blob/main/examples/telephone-stateful/src/test/java/org/superbiz/telephone/TelephoneTest.java[TelephoneTest.java]
...
link:https://github.com/apache/tomee/blob/main/examples/telephone-stateful/pom.xml[pom.xml]
...
directory of the link:https://github.com/apache/tomee/tree/main/examples/telephone-stateful[telephone-stateful example], just run:
