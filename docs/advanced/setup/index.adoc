= How to set up TomEE in production
:jbake-date: 2016-03-16
:jbake-type: page
:jbake-status: published


You can use TomEE as described on link:../../admin/file-layout.html[Directory Structure] page but in production it is better to
