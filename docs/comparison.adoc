...
== [[specifications]] Detailed list of Java EE 7.0

[options="header",cols="1,4*^0"]
|===
...
|https://jcp.org/en/jsr/detail?id=375[Java Security^] (Java EE Enterprise Security)|{n}|{n}|{n}|{n}
...
// WEB PROFILE
|https://download.oracle.com/otn-pub/jcp/java_ee-7-fr-eval-spec/WebProfile.pdf[Java EE Web Profile specifications^] 7.0||{y}|{y}|{y}
