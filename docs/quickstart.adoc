...
To install OpenEJB, simply https://tomee.apache.org/download-ng.html[download the latest
...
link:deploy-tool.html[deploy] and link:startup.html[start].
...
link:hello-world.html[Hello World] example.
...
list can be found https://lists.apache.org/list.html?users@tomee.apache.org[here]
