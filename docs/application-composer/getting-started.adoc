...
JAXRS and JAXWS endpoints are served by TomEE; to test them over HTTP use
TomEE Embedded or the Arquillian TomEE adapters.
...
`RuleChain` you can chain them to get the same behavior as
