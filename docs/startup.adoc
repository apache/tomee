...
`[user@host openejb-3.0]# ./bin/openejb start`
...
port to which the hsql service should be bound.| | _--local-copy _ | Instructs the container system to marshal
...
OpenEJB Remote Server ** Starting Services ** NAME IP PORT telnet
0.0.0.0 4202 ejbd 0.0.0.0 4201 hsql 0.0.0.0 9001
