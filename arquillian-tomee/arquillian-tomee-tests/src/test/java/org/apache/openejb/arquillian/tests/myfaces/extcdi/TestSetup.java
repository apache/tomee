 ...
 */
package org.apache.openejb.arquillian.tests.myfaces.extcdi;

import org.apache.myfaces.extensions.cdi.jsf.impl.config.view.DefaultPageParameterStrategy;
...
public abstract class TestSetup {
    ...
    public WebArchive createDeployment(Class...archiveClasses) {
        ...
        WebArchive archive = ShrinkWrap.create(WebArchive.class, getTestContextName() + ".war")
                ...
                .addAsLibraries(JarLocation.jarLocation(DefaultPageParameterStrategy.class))
                .addAsWebInfResource(EmptyAsset.INSTANCE, ArchivePaths.create("beans.xml"))
                .addAsWebInfResource(EmptyAsset.INSTANCE, "META-INF/context.xml");
