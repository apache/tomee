...
public class Utility {
    ...
    public void save(String key, Object obj) {
        UserSessionListener.getServiceContext(this.params.getReq().getSession()).getSaved().put(key, obj);
    }

    public Object get(String key) {
        return UserSessionListener.getServiceContext(this.params.getReq().getSession()).getSaved().get(key);
    }
}
