...
public class TomEETldScanner extends TldScanner {
    ...
    private static void populateMyfacesAndJstlData() {
        ...
        if (JSTL_URL != null) {
            ...
            }
            {
                ...
                taglibXml.setValidator(validator);
                taglibXml.getValidator().addInitParam("expressionAttributes", "out:escapeXml 	    parse:xml 	    parse:systemId 	    parse:filter 	    transform:xml 	    transform:xmlSystemId 	    transform:xslt 	    transform:xsltSystemId 	    transform:result");
                {
                    final TagXml tag = new TagXml();
                    tag.setName("choose");
            ...
            }
            {
                ...
                taglibXml.setValidator(validator);
                taglibXml.getValidator().addInitParam("expressionAttributes", "out:value 	    out:default 	    out:escapeXml 	    if:test 	    import:url 	    import:context 	    import:charEncoding 	    forEach:items 	    forEach:begin 	    forEach:end 	    forEach:step 	    forTokens:items 	    forTokens:begin 	    forTokens:end 	    forTokens:step 	    param:encode 	    param:name 	    param:value             redirect:context             redirect:url 	    set:property 	    set:target 	    set:value 	    url:context 	    url:value 	    when:test");
                {
                    final TagXml tag = new TagXml();
                    tag.setName("catch");
    ...
    private void sysout() {
        ...
        for (final Map.Entry<String, TldResourcePath> entry : URI_TLD_RESOURCE.entrySet()) {
            ...
            final TaglibXml tagLibs = TLD_RESOURCE_TAG_LIB.get(entry.getValue());
            if (tagLibs != null) {
                System.out.println("final TaglibXml taglibXml = new TaglibXml();");
                System.out.println("taglibXml.setTlibVersion(\"" + tagLibs.getTlibVersion() + "\");");
                System.out.println("taglibXml.setJspVersion(\"" + tagLibs.getJspVersion() + "\");");
                System.out.println("taglibXml.setShortName(\"" + tagLibs.getShortName() + "\");");
                System.out.println("taglibXml.setUri(\"" + tagLibs.getUri() + "\");");
                System.out.println("taglibXml.setInfo(\"" + t(tagLibs.getInfo()) + "\");");
                ...
                for (final TagXml xml : tagLibs.getTags()) {
                    ...
                    System.out.println("tag.setName(\"" + xml.getName() + "\");");
                    System.out.println("tag.setTagClass(\"" + xml.getTagClass() + "\");");
                    System.out.println("tag.setTeiClass(\"" + xml.getTeiClass() + "\");");
                    System.out.println("tag.setBodyContent(\"" + xml.getBodyContent() + "\");");
                    System.out.println("tag.setDisplayName(\"" + xml.getDisplayName() + "\");");
                    System.out.println("tag.setSmallIcon(\"" + xml.getSmallIcon() + "\");");
                    System.out.println("tag.setLargeIcon(\"" + xml.getLargeIcon() + "\");");
                    System.out.println("tag.setInfo(\"" + t(xml.getInfo()) + "\");");
                    System.out.println("tag.setDynamicAttributes(" + xml.hasDynamicAttributes() + ");");
                ...
                for (final TagFileXml file : tagLibs.getTagFiles()) {
                    ...
                    System.out.println("file.setName(\"" + file.getName() + "\");");
                    System.out.println("file.setPath(\"" + file.getPath() + "\");");
                    System.out.println("file.setDisplayName(\"" + file.getDisplayName() + "\");");
                    System.out.println("file.setSmallIcon(\"" + file.getSmallIcon() + "\");");
                    System.out.println("file.setLargeIcon(\"" + file.getLargeIcon() + "\");");
                    System.out.println("file.setInfo(\"" + t(file.getInfo()) + "\");");
