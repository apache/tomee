...
<head>
  ...
  <link href="<c:url value='/app/lib/codemirror/lib/codemirror.css'/>" rel="stylesheet">
  <link href="<c:url value='/app/lib/codemirror/addon/hint/show-hint.css'/>" rel="stylesheet">
