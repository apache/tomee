    ...
    public void testTomEECliWithJar() throws IOException, InterruptedException {
        ...
        final ProcessBuilder builder = new ProcessBuilder()
                .command("java", "-cp", jar.getAbsolutePath() + File.pathSeparator +
                                ...
                                tomee.getAbsolutePath() + File.separator + "lib" + File.separator + commonsLang[0] + File.pathSeparator +
                                tomee.getAbsolutePath() + File.separator + "lib" + File.separator + commonsLang[1],
