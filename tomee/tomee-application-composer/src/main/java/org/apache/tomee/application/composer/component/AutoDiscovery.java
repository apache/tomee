...
/**
 * Mark the application class with it to let the container handle scanning itself.
 */
@Target(TYPE)
@Retention(RUNTIME)
public @interface AutoDiscovery {
    /**
     * @return true if the jar containing the application contains EE components to scan
     */
