...
public class SeiFactoryImpl implements SeiFactory {
    ...
    public SeiFactoryImpl(final QName serviceName,
                          final String portName,
                          final String serviceEndpointClassName,
                          final OperationInfo[] operationInfos,
                          final List typeInfo,
                          final URL location,
    ...
    void initialize(final Object serviceImpl, final ClassLoader classLoader) throws ClassNotFoundException {
    ...
    private Class enhanceServiceEndpointInterface(final Class serviceEndpointInterface, final ClassLoader classLoader) {
