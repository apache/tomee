...
public class EntityEJBHomeHandler extends EJBHomeHandler {
    ...
    protected Object findX(Method method, Object[] args, Object proxy) throws Throwable {
        EJBRequest req = new EJBRequest(RequestMethodCode.EJB_HOME_FIND, ejb, method, args, null, client.getSerializer());
    ...
    protected Object removeByPrimaryKey(Method method, Object[] args, Object proxy) throws Throwable {
        ...
        EJBRequest req = new EJBRequest(RequestMethodCode.EJB_HOME_REMOVE_BY_PKEY, ejb, method, args, primKey, client.getSerializer());
