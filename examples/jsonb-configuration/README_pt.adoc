...
http://localhost:8080/jsonb-configuration/api/users que deve responder com o seguinte json: [ \{ ``Id'':1, ``Name'':``user 1'',
...
javaee-api:8.0 traz todas as dependências necessárias para girar
