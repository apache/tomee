...
Um exemplo completo pode ser encontrado https://github.com/apache/tomee/tree/master/examples/tomee-jersey-eclipselink[here].
É um projeto maven, e o teste pode ser executado com `mvn clean install` comando.
