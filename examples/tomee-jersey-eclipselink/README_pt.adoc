...
https://eclipse-ee4j.github.io/jersey/[Jersey] será usado para criar o serviço da web..
...
O Jersey é usado no lugar da implementação JAX-RS baseada em CXF que vem com o TomEE, então a webapp desativa esta última
em `webapp/WEB-INF/application.properties`:
...
O EclipseLink é fornecido pela distribuição TomEE Plume, que também é a usada pelo teste.
