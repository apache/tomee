...
O Bean Validation (também conhecida como JSR 303) contém um apêndice opcional
método de validação.
...
exemplo você especificar os centímetros mínimos de um homem do esporte deve pular
no salto com vara:
