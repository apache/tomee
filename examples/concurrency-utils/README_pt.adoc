...
Além disso, em um objeto de thread não gerenciado, o contêiner não pode garantir que outros serviços da plataforma JEE funcionem corretamente. Por esses motivos, é recomendável o uso de threads gerenciadas sempre que a necessidade surgir.
