= Estágio do Projeto DeltaSpike
:index-group: Testing Techniques
:jbake-type: page
:jbake-status: published

Este exemplo mostra como usar https://deltaspike.apache.org/documentation/projectstage.html[deltaSpike project stage] nos testes do Arquillian em execução no TomEE.
