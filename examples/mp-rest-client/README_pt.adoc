...
Os casos de teste para este projeto são criados usando o Arquillian e o TomEE Remote. A configuração arquilar pode ser encontrada em `src/test/resources/arquillian.xml`.
