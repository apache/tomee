...
Hibernate faça isso se você declarar seus bancos de dados que funcionará. Contudo
com o OpenJPA (o provedor JPA padrão para o OpenEJB), a criação é
preguiçoso e isso acontece apenas uma vez; quando você alterna o banco de dados, ele
chega de trabalho.
