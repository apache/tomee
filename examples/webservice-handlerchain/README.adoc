...
[arabic]
. Create handler(s) implementing `jakarta.xml.ws.handler.soap.SOAPHandler`
...
INFO: ------------------------- localhost -> /webservice-handlerchain
INFO: Configuring enterprise application: /path/to/examples/webservice-handlerchain/target/tomee-embedded/0/webservice-handlerchain
...
INFO: Webservice(wsdl=http://localhost:53503/webservice-handlerchain/webservices/Calculator, qname={http://superbiz.org/wsdl}CalculatorService) --> Ejb(id=Calculator)
INFO: Deployed Application(path=/path/to/examples/webservice-handlerchain/target/tomee-embedded/0/webservice-handlerchain)
INFO: Creating Service {http://superbiz.org/wsdl}CalculatorService from WSDL: http://localhost:53503/webservice-handlerchain/webservices/Calculator?wsdl
INFO: Undeploying app: /path/to/examples/webservice-handlerchain/target/tomee-embedded/0/webservice-handlerchain
Tests run: 1, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 2.124 s -- in org.superbiz.calculator.wsh.CalculatorTest
...
The execution above would generate the following messages.
...
<wsdl:definitions xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/"
  ...
  <wsdl:service name="CalculatorService">
    <wsdl:port binding="tns:CalculatorServiceSoapBinding" name="CalculatorPort">
      <soap:address location="http://127.0.0.1:8080/webservice-handlerchain/webservices/Calculator"/>
    </wsdl:port>
  </wsdl:service>
</wsdl:definitions>
----
