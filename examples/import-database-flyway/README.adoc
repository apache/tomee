...
The unit test is tied to a set of SQL statements, defined in the script `V1_0__import-ImportSqlScriptTest.sql`:
...
2 - Run the build of the examples/import-database-flyway project:
