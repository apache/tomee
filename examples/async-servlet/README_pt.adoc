...
Servlets pode ser executado assincronamente - isso pode ser util se seu servlet executa operações de longa execução, como chamar
...
Se você escrever para a resposta diretamente do seu Runnable (nº 1 abaixo), você corre o risco de sofrer uma condição de corrida com outra thread usando a resposta.
