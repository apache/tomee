...
public class FinalizePaymentQualifierTest {
    ...
    public void mustInjectCashType() {
    	...
    	String response = finalizePayment.finishByQualifier(PaymentType.CASH);
    ...
    public void mustInjectCreditCardType() {
    	...
    	String response = finalizePayment.finishByQualifier(PaymentType.CREDITCARD);
