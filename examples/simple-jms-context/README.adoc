...
31-Mar-2020 20:38:08.564 INFO [main] org.apache.openejb.assembler.classic.JndiBuilder.bind Jndi(name=global/openejb/openejb/openejb/Deployer!jakarta.management.j2ee.ManagementHome) --> Ejb(deployment-id=MEJB)
