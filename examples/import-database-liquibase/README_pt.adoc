...
[source,sql]
----
CREATE TABLE pulbic.table_test (ID INT NOT NULL, DESCRIPTION VARCHAR(120) NOT NULL, PRIMARY KEY (ID));
insert into pulbic.table_test (id, description) values(1, 'Test 1');
insert into pulbic.table_test (id, description) values(2, 'Test 2');
insert into pulbic.table_test (id, description) values(3, 'Test 3');
----
...
2 - Executar o build do projeto examples/import-database-liquibase: 
