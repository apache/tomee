...
public class ObjectFactory {
    ...
    public JAXBElement<Application> createApplication(final Application value) {
        return new JAXBElement<>(_Application_QNAME, Application.class, null, value);
    }
    ...
    public JAXBElement<ApplicationClient> createApplicationClient(final ApplicationClient value) {
        return new JAXBElement<>(_ApplicationClient_QNAME, ApplicationClient.class, null, value);
    }
    ...
    public JAXBElement<EjbJar> createEjbJar(final EjbJar value) {
        return new JAXBElement<>(_EjbJar_QNAME, EjbJar.class, null, value);
    }
    ...
    public JAXBElement<String> createEjbRelationTypeEjbRelationName(final String value) {
        return new JAXBElement<>(_EjbRelationTypeEjbRelationName_QNAME, String.class, EjbRelation.class, value);
    }
    ...
    public JAXBElement<EjbRelationshipRole> createEjbRelationTypeEjbRelationshipRole(final EjbRelationshipRole value) {
        return new JAXBElement<>(_EjbRelationTypeEjbRelationshipRole_QNAME, EjbRelationshipRole.class, EjbRelation.class, value);
    }
    ...
    public JAXBElement<Text> createEjbRelationTypeDescription(final Text value) {
        return new JAXBElement<>(_EjbRelationTypeDescription_QNAME, Text.class, EjbRelation.class, value);
    }
    ...
    public JAXBElement<String> createWebResourceCollectionTypeHttpMethod(final String value) {
        return new JAXBElement<>(_WebResourceCollectionTypeHttpMethod_QNAME, String.class, WebResourceCollection.class, value);
    }
    ...
    public JAXBElement<WebApp> createWebApp(final WebApp value) {
        return new JAXBElement<>(_WebApp_QNAME, WebApp.class, null, value);
    }
    ...
    public JAXBElement<TldTaglib> createTldTaglib(final TldTaglib value) {
        return new JAXBElement<>(_TldTaglib_QNAME, TldTaglib.class, null, value);
    }
    ...
    public JAXBElement<JavaWsdlMapping> createConnector(final JavaWsdlMapping value) {
        return new JAXBElement<>(_JavaWsdlMapping_QNAME, JavaWsdlMapping.class, null, value);
    }
    ...
    public JAXBElement<Webservices> createConnector(final Webservices value) {
        return new JAXBElement<>(_Webservices_QNAME, Webservices.class, null, value);
    }
    ...
    public JAXBElement<FacesConfig> createFacesConfig(final FacesConfig value) {
        return new JAXBElement<>(_FacesConfig_QNAME, FacesConfig.class, null, value);
    }
    ...
    public JAXBElement<WebFragment> createWebFragment(final WebFragment value) {
        return new JAXBElement<>(_WebFragment_QNAME, WebFragment.class, null, value);
    }
}
