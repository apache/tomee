...
public enum SubscriptionDurabilityEnum {
	...
	SubscriptionDurabilityEnum(String v) {
		value = v;
	}
	...
	public static SubscriptionDurabilityEnum fromValue(String v) {
		for (SubscriptionDurabilityEnum c : SubscriptionDurabilityEnum.values()) {
			if (c.value.equals(v)) {
				return c;
			}
		}
