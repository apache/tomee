    ...
    extends JAXBObject<FacesNullValue>
{
    ...
    public static final FacesNullValue _read(XoXMLStreamReader reader, RuntimeContext context)
        throws Exception
    {
    ...
    public static final void _write(XoXMLStreamWriter writer, FacesNullValue facesNullValue, RuntimeContext context)
        throws Exception
    {
