    ...
    extends JAXBObject<FacesApplicationExtension>
{
    ...
    public static final FacesApplicationExtension _read(XoXMLStreamReader reader, RuntimeContext context)
        throws Exception
    {
    ...
    public static final void _write(XoXMLStreamWriter writer, FacesApplicationExtension facesApplicationExtension, RuntimeContext context)
        throws Exception
    {
