    ...
    extends JAXBObject<TldDeferredMethod>
{
    ...
    public static final TldDeferredMethod _read(XoXMLStreamReader reader, RuntimeContext context)
        throws Exception
    {
        ...
        for (XoXMLStreamReader elementReader: reader.getChildElements()) {
            if (("method-signature" == elementReader.getLocalName())&&("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                String methodSignatureRaw = elementReader.getElementText();
    ...
    public static final void _write(XoXMLStreamWriter writer, TldDeferredMethod tldDeferredMethod, RuntimeContext context)
        throws Exception
    {
