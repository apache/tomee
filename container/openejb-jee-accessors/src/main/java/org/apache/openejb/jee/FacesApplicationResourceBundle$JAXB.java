    ...
    extends JAXBObject<FacesApplicationResourceBundle>
{
    ...
    public static final FacesApplicationResourceBundle _read(XoXMLStreamReader reader, RuntimeContext context)
        throws Exception
    {
        ...
        for (XoXMLStreamReader elementReader: reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())&&("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                // ELEMENT: baseName
                String baseNameRaw = elementReader.getElementText();
                ...
                // ELEMENT: var
                String varRaw = elementReader.getElementText();
    ...
    public static final void _write(XoXMLStreamWriter writer, FacesApplicationResourceBundle facesApplicationResourceBundle, RuntimeContext context)
        throws Exception
    {
