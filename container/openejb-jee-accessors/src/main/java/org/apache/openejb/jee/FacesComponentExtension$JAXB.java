    ...
    extends JAXBObject<FacesComponentExtension>
{
    ...
    public static final FacesComponentExtension _read(XoXMLStreamReader reader, RuntimeContext context)
        throws Exception
    {
    ...
    public static final void _write(XoXMLStreamWriter writer, FacesComponentExtension facesComponentExtension, RuntimeContext context)
        throws Exception
    {
