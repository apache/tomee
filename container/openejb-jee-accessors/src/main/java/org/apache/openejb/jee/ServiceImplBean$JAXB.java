    ...
    extends JAXBObject<ServiceImplBean>
{
    ...
    public static final ServiceImplBean _read(XoXMLStreamReader reader, RuntimeContext context)
        throws Exception
    {
        ...
        for (XoXMLStreamReader elementReader: reader.getChildElements()) {
            if (("ejb-link" == elementReader.getLocalName())&&("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: ejbLink
                String ejbLinkRaw = elementReader.getElementText();
                ...
                // ELEMENT: servletLink
                String servletLinkRaw = elementReader.getElementText();
    ...
    public static final void _write(XoXMLStreamWriter writer, ServiceImplBean serviceImplBean, RuntimeContext context)
        throws Exception
    {
