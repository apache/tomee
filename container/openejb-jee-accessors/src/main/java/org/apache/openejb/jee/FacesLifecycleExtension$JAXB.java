    ...
    extends JAXBObject<FacesLifecycleExtension>
{
    ...
    public static final FacesLifecycleExtension _read(XoXMLStreamReader reader, RuntimeContext context)
        throws Exception
    {
    ...
    public static final void _write(XoXMLStreamWriter writer, FacesLifecycleExtension facesLifecycleExtension, RuntimeContext context)
        throws Exception
    {
