    ...
    extends JAXBObject<AroundTimeout>
{
    ...
    public static final AroundTimeout _read(XoXMLStreamReader reader, RuntimeContext context)
        throws Exception
    {
    ...
    public static final void _write(XoXMLStreamWriter writer, AroundTimeout aroundTimeout, RuntimeContext context)
        throws Exception
    {
