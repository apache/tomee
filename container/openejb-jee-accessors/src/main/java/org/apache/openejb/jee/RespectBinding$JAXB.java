    ...
    extends JAXBObject<RespectBinding>
{
    ...
    public static final RespectBinding _read(XoXMLStreamReader reader, RuntimeContext context)
        throws Exception
    {
    ...
    public static final void _write(XoXMLStreamWriter writer, RespectBinding respectBinding, RuntimeContext context)
        throws Exception
    {
