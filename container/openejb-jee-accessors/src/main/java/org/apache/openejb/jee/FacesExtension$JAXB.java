    ...
    extends JAXBObject<FacesExtension>
{
    ...
    public static final FacesExtension _read(XoXMLStreamReader reader, RuntimeContext context)
        throws Exception
    {
    ...
    public static final void _write(XoXMLStreamWriter writer, FacesExtension facesExtension, RuntimeContext context)
        throws Exception
    {
