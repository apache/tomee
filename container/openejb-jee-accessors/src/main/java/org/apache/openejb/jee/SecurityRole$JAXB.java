    ...
    extends JAXBObject<SecurityRole>
{
    ...
    public static final SecurityRole _read(XoXMLStreamReader reader, RuntimeContext context)
        throws Exception
    {
    ...
    public static final void _write(XoXMLStreamWriter writer, SecurityRole securityRole, RuntimeContext context)
        throws Exception
    {
