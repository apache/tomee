    ...
    extends JAXBObject<FacesFromAction>
{
    ...
    public static final FacesFromAction _read(XoXMLStreamReader reader, RuntimeContext context)
        throws Exception
    {
    ...
    public static final void _write(XoXMLStreamWriter writer, FacesFromAction facesFromAction, RuntimeContext context)
        throws Exception
    {
