    ...
    extends JAXBObject<ManagedBean>
{
        ...
        throws Exception
    {
        ...
        for (XoXMLStreamReader elementReader: reader.getChildElements()) {
            if (("hidden" == elementReader.getLocalName())&&("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                if (managedExecutor == null) {
                    managedExecutor = managedBean.managedExecutor;
                    if (managedExecutor!= null) {
                ...
                if (managedScheduledExecutor == null) {
                    managedScheduledExecutor = managedBean.managedScheduledExecutor;
                    if (managedScheduledExecutor!= null) {
                ...
                if (managedThreadFactory == null) {
                    managedThreadFactory = managedBean.managedThreadFactory;
                    if (managedThreadFactory!= null) {
        ...
        if (managedExecutor!= null) {
            managedBean.managedExecutor = managedExecutor;
        }
        if (managedScheduledExecutor!= null) {
            managedBean.managedScheduledExecutor = managedScheduledExecutor;
        }
        if (managedThreadFactory!= null) {
            managedBean.managedThreadFactory = managedThreadFactory;
        }
        ...
        throws Exception
    {
        ...
        // ELEMENT: managedExecutor
        KeyedCollection<String, ManagedExecutor> managedExecutor = managedBean.managedExecutor;
        if (managedExecutor!= null) {
        ...
        // ELEMENT: managedScheduledExecutor
        KeyedCollection<String, ManagedScheduledExecutor> managedScheduledExecutor = managedBean.managedScheduledExecutor;
        if (managedScheduledExecutor!= null) {
        ...
        // ELEMENT: managedThreadFactory
        KeyedCollection<String, ManagedThreadFactory> managedThreadFactory = managedBean.managedThreadFactory;
        if (managedThreadFactory!= null) {
