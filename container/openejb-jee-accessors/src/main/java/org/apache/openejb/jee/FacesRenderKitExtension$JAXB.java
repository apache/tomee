    ...
    extends JAXBObject<FacesRenderKitExtension>
{
    ...
    public static final FacesRenderKitExtension _read(XoXMLStreamReader reader, RuntimeContext context)
        throws Exception
    {
    ...
    public static final void _write(XoXMLStreamWriter writer, FacesRenderKitExtension facesRenderKitExtension, RuntimeContext context)
        throws Exception
    {
