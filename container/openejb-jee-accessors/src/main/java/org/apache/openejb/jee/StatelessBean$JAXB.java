    ...
    extends JAXBObject<StatelessBean>
{
        ...
        throws Exception
    {
        ...
        for (XoXMLStreamReader elementReader: reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())&&("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                if (managedScheduledExecutor == null) {
                    managedScheduledExecutor = statelessBean.managedScheduledExecutor;
                    if (managedScheduledExecutor!= null) {
                ...
                if (managedThreadFactory == null) {
                    managedThreadFactory = statelessBean.managedThreadFactory;
                    if (managedThreadFactory!= null) {
        ...
        if (managedExecutor!= null) {
            statelessBean.managedExecutor = managedExecutor;
        }
        if (managedScheduledExecutor!= null) {
            statelessBean.managedScheduledExecutor = managedScheduledExecutor;
        }
        if (managedThreadFactory!= null) {
            statelessBean.managedThreadFactory = managedThreadFactory;
        }
        ...
        throws Exception
    {
        ...
        // ELEMENT: managedExecutor
        KeyedCollection<String, ManagedExecutor> managedExecutor = statelessBean.managedExecutor;
        if (managedExecutor!= null) {
        ...
        // ELEMENT: managedScheduledExecutor
        KeyedCollection<String, ManagedScheduledExecutor> managedScheduledExecutor = statelessBean.managedScheduledExecutor;
        if (managedScheduledExecutor!= null) {
        ...
        // ELEMENT: managedThreadFactory
        KeyedCollection<String, ManagedThreadFactory> managedThreadFactory = statelessBean.managedThreadFactory;
        if (managedThreadFactory!= null) {
