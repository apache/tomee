 ...
 */
public interface EntityEjbContainer extends EjbContainer {
    void setContext(EJBInstanceContext instanceContext, EntityContext entityContext) throws Throwable;

    void unsetContext(EJBInstanceContext instanceContext) throws Throwable;

    void ejbActivate(EJBInstanceContext instanceContext) throws Throwable;
