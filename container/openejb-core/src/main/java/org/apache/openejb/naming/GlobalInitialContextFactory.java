...
public class GlobalInitialContextFactory implements javax.naming.spi.InitialContextFactory {
    
    public Context getInitialContext(Hashtable env) throws javax.naming.NamingException {

        Context context = null; //TODO: org.apache.openejb.OpenEJB.getJNDIContext();
