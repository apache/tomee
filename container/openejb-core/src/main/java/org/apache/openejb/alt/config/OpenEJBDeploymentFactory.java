...
public class OpenEJBDeploymentFactory implements DeploymentFactory {
    ...
    private static org.apache.openejb.alt.config.DeploymentFactory factory = new DeploymentImpl.DeploymentFactoryImpl();
//    static {
...
//            Class impl = resourceFinder.findImplementation(org.apache.openejb.alt.config.DeploymentFactory.class);
//            factory = (org.apache.openejb.alt.config.DeploymentFactory) impl.newInstance();
//        } catch (Exception ignored) {
//            // todo maybe log this
//        }
//    }

    public static org.apache.openejb.alt.config.DeploymentFactory getFactory() {
        return factory;
    }

    public static void setFactory(org.apache.openejb.alt.config.DeploymentFactory factory) {
