    ...
    public class MyTransactionManager implements TransactionManager {
        public UserTransaction getUserTransaction(Object txID) {
            return new UserTransaction() {
                public void begin() {
                    MyTransactionManager.this.begin();
                }

                public void commit() throws RollbackException {
                    MyTransactionManager.this.commit();
                }
                ...
                public void rollback() {
                    MyTransactionManager.this.rollback();
                }

                public void setRollbackOnly() {
                    MyTransactionManager.this.setRollbackOnly();
                }

                public void setTransactionTimeout(int seconds) {
                    MyTransactionManager.this.setTransactionTimeout(seconds);
                }
            };
        }
