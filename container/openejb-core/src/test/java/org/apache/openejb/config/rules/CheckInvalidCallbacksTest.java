...
public class CheckInvalidCallbacksTest extends TestCase {
    ...
    public class CallbackViolatorBean {
    	@PostConstruct public void postConstruct(InvocationContext ic) {}
    	@PreDestroy public void preDestroy(InvocationContext ic) {}
    	@PrePassivate public void prePassivate(InvocationContext ic) {}
    	@PostActivate public void postActivate(InvocationContext ic) {}
    }
}